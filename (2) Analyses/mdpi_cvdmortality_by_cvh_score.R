...
outcome.covar.dat.all.cause<-outcome.dat.cvd %>%
...
formula.0.glm.cvh <- Deaths ~ 1 + scale(pct_65_older)
formula.1.glm.cvh <- Deaths ~ 1 + scale(pct_65_older) + scale(cle8_point) 
...
### Model 0: Intercept-only model
mod.0.CA.icar <- inla(formula.0.icar.CA, family = "poisson", data = merged_proj_CA, E = ExpectedCVDDeaths,
                  control.predictor = list(compute = TRUE),
                  control.compute = list(return.marginals.predictor = TRUE, 
                                         dic = TRUE, cpo = TRUE, waic = TRUE))
...
### Model 1: CVH score as a covariate
mod.1.CA.icar <- inla(formula.1.icar.CA, family = "poisson", data = merged_proj_CA, E = ExpectedCVDDeaths,
                  control.predictor = list(compute = TRUE),
                  control.compute = list(return.marginals.predictor = TRUE, 
                                         dic = TRUE, cpo = TRUE, waic = TRUE))
...
### Model 0: Intercept-only model
mod.0.CA.bym <- inla(formula.0.bym.CA, family = "poisson", data = merged_proj_CA, E = ExpectedCVDDeaths,
                  control.predictor = list(compute = TRUE),
                  control.compute = list(return.marginals.predictor = TRUE, 
                                         dic = TRUE, cpo = TRUE, waic = TRUE))
...
### Model 1: CVH score as a covariate
mod.1.CA.bym <- inla(formula.1.bym.CA, family = "poisson", data = merged_proj_CA, E = ExpectedCVDDeaths,
                  control.predictor = list(compute = TRUE),
                  control.compute = list(return.marginals.predictor = TRUE, 
                                         dic = TRUE, cpo = TRUE, waic = TRUE))
...
### Model 0: Intercept-only model
mod.0.GA.icar <- inla(formula.0.icar.GA, family = "poisson", data = merged_proj_GA, E = ExpectedCVDDeaths,
                  control.predictor = list(compute = TRUE),
                  control.compute = list(return.marginals.predictor = TRUE, 
                                         dic = TRUE, cpo = TRUE, waic = TRUE))
...
### Model 1: CVH score as a covariate
mod.1.GA.icar <- inla(formula.1.icar.GA, family = "poisson", data = merged_proj_GA, E = ExpectedCVDDeaths,
                  control.predictor = list(compute = TRUE),
                  control.compute = list(return.marginals.predictor = TRUE, 
                                         dic = TRUE, cpo = TRUE, waic = TRUE))
...
### Model 0: Intercept-only model
mod.0.GA.bym <- inla(formula.0.bym.GA, family = "poisson", data = merged_proj_GA, E = ExpectedCVDDeaths,
                  control.predictor = list(compute = TRUE),
                  control.compute = list(return.marginals.predictor = TRUE, 
                                         dic = TRUE, cpo = TRUE, waic = TRUE))
...
### Model 1: CVH score as a covariate
mod.1.GA.bym <- inla(formula.1.bym.GA, family = "poisson", data = merged_proj_GA, E = ExpectedCVDDeaths,
                  control.predictor = list(compute = TRUE),
                  control.compute = list(return.marginals.predictor = TRUE, 
                                         dic = TRUE, cpo = TRUE, waic = TRUE))
...
### Model 0: Intercept-only model
mod.0.TX.icar <- inla(formula.0.icar.TX, family = "poisson", data = merged_proj_TX, E = ExpectedCVDDeaths,
                  control.predictor = list(compute = TRUE),
                  control.compute = list(return.marginals.predictor = TRUE, 
                                         dic = TRUE, cpo = TRUE, waic = TRUE))
...
### Model 1: CVH score as a covariate
mod.1.TX.icar <- inla(formula.1.icar.TX, family = "poisson", data = merged_proj_TX, E = ExpectedCVDDeaths,
                  control.predictor = list(compute = TRUE),
                  control.compute = list(return.marginals.predictor = TRUE, 
                                         dic = TRUE, cpo = TRUE, waic = TRUE))
...
### Model 0: Intercept-only model
mod.0.TX.bym <- inla(formula.0.bym.TX, family = "poisson", data = merged_proj_TX, E = ExpectedCVDDeaths,
                  control.predictor = list(compute = TRUE),
                  control.compute = list(return.marginals.predictor = TRUE, 
                                         dic = TRUE, cpo = TRUE, waic = TRUE))
...
### Model 1: CVH score as a covariate
mod.1.TX.bym <- inla(formula.1.bym.TX, family = "poisson", data = merged_proj_TX, E = ExpectedCVDDeaths,
                  control.predictor = list(compute = TRUE),
                  control.compute = list(return.marginals.predictor = TRUE, 
                                         dic = TRUE, cpo = TRUE, waic = TRUE))
...
write.csv(Var.res, "Output/Results/CVD_Mortality_variance_components.csv", row.names = TRUE)
