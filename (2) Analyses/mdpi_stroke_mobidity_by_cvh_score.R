...
##########   CA   ##########    
##### GLMs for Stroke morbidity in CA
...
##########   GA   ##########    
##### GLMs for Stroke morbidity in GA
### Model 0: Intercept-only model
...
##########   TX   ##########    
##### GLMs for Stroke morbidity in TX
### Model 0: Intercept-only model
...
write.csv(Var.res, "Output/Results/STROKE_Morbidity_variance_components.csv", row.names = TRUE)
...
write.csv(rbind(CA.out %>% as.data.frame() %>% arrange(DIC),
          ...
          "Output/Results/STROKE_NB-model_results.csv",
          row.names = TRUE)

write.csv(rbind(CA.fixed, GA.fixed, TX.fixed),
          "Output/Results/STROKE_NB-model_fixed_effects.csv",
          row.names = TRUE)
